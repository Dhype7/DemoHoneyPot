"""
Sample Configuration file for the Honeypot System
================================================

Copy this file to settings.py and customize the values below.
...
TELEGRAM_CHAT_ID = 123456789  # Replace with your actual chat ID (as integer)
...
ABUSEIPDB_KEY = "your_abuseipdb_key_here"  # Get from https://www.abuseipdb.com/
SHODAN_KEY = "your_shodan_key_here"     # Get from https://account.shodan.io/
...
WEB_DEBUG_MODE = True
WEB_SECRET_KEY = "change-this-to-a-random-secret-key"
